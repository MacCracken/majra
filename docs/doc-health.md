...
| `roadmap.md` | 2026-07-28 | ✅ Fresh | 2.5.2 entry added at top of "Recently shipped" (cyrius 6.4.62 → 6.4.83, sigil 3.11.1 → 3.12.1, sakshi promoted to a declared dep at 2.4.6, `cyrius bench` entry-point repair, distribution-based benchmark regression check). 2.5.1 / 2.5.0 entries retained. "Waiting on upstream" empty — both long-standing blockers cleared at 2.4.5. |

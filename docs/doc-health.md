...
> **Last refresh**: 2026-06-15 (2.4.7 toolchain refresh — cyrius pin 6.1.35 → 6.2.11, sigil 3.7.10 → 3.7.14, transitive agnosys 1.3.2 → 1.4.3; the 6.2.x stdlib snapshot grew the lib-sync set 88 → 97 files (lockfile now 97 hashes). CHANGELOG + state.md + dependency-watch.md + roadmap.md touched. No source-logic change; bundle bodies byte-identical to 2.4.6.) | **Refresh cadence**: when docs are touched, update the affected row. No release attachment.
